...
import healthMapRoutes from './routes/health-map.js';
import radarStatusRoutes from './routes/radar-status.js';
...
fastify.register(healthMapRoutes);
fastify.register(radarStatusRoutes);
